  ...
  const renderForecast = () => {
    ...
    return (
      ...
      >
        ...
        <div>
          <h3 style={{ fontSize: '1.2rem', marginBottom: '8px', color: '#333' }}>📅 3-Day Forecast [3 Hour Interval]</h3>
  ...
  const renderContactSection = () => {
    return (
      <div style={{
        ...
        <h2 style={{ fontSize: '1.5rem', fontWeight: '600', marginBottom: '12px' }}>📬 Volunteer With Us</h2>
        <p style={{ marginBottom: '20px' }}>
          We organise monthly clean up at Sungai Dilik to ensure smooth and consistent water supply to the community. 
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#ffffff', color: '#222', padding: '24px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ display: 'flex', marginBottom: '16px' }}>
        ...
        <button
          onClick={() => setActiveSection('Volunteer With Us')}
          style={{
            padding: '10px 20px',
            fontSize: '1rem',
